...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('myapp', '0017_order_not_complete_order_tracking_number_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bank_account', models.CharField(choices=[('KBank', 'KBank'), ('SCB', 'SCB'), ('TTB', 'TTB'), ('KTB', 'KTB'), ('BBL', 'BBL'), ('BAY', 'BAY'), ('อื่น', 'อื่น')], default='KBank', max_length=50)),
